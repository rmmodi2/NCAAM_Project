...
AllGames_1011 = read.csv("/Users/ronakmodi/Desktop/NCAAM_Project/Data/AllGames/NCAAM_AllGames_1011.csv",header=TRUE,colClasses=colClassesAllGames,na.strings=naValuesAllGames)
AllGames_1011
```
```{r}
allGames1011 <- filter(AllGames_1011,Date!="3/15/11",Date!="3/16/11",Date!="3/17/11",Date!="3/18/11",Date!="3/24/11",Date!="3/25/11",Date!="3/26/11",Date!="3/27/11",Date!="4/2/11",Date!='4/4/11',substring(AllGames_1011$Result,1,1)=='W',Opp %in% Schl)
allGames1011 = data.frame(winner=allGames1011$Schl,loser=allGames1011$Opp,Freq=1)
...
```{r}
colClassesTGames = c(rep("NULL",2),"character","NULL","character","character",rep("NULL",14))
tournamentGames_1011 = read.csv("/Users/ronakmodi/Desktop/NCAAM_Project/Data/TournamentGames/NCAAM_TournamentGames_1011.csv",header=TRUE,colClasses=colClassesTGames,na.strings=naValuesAllGames)
tournamentGames_1011 <- na.omit(tournamentGames_1011)
```
